...
@section('page_header')
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('delete-all-messages')}}">
					@csrf
					
					<button onclick="return confirm('Are you sure you want to delete all messages?')" type="submit" class="btn btn-primary">
						Delete All
					</button>
		</form>
