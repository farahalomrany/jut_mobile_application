...
<!-- edit read add section to view button-->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- <div class="modal-header">
                   <button  type="button"  class="btn btn-primary btn-add-new">Add Products</button>
                </div> -->
            ...
            <div class="card" style="margin: 0px 10px;">
                ...
                <table id="table-add-opt" class="table datatable-basic table-striped" style=" margin: 0;">
                    ...
                    <tbody>
                        ...
                        @php
                        $points =
                        App\Models\CampaignProduct::where('campaign_id',$id)->where('product_id',$product->id)->first()->points;
...
<!-- Disrtibutors for this campaign -->
<div class="page-content read container-fluid">

    <div class="row">
        <div class="col-md-12">
            <h3 class="mb-0 font-weight-semibold">
                Disrtibutors Details
            </h3>
            ...
            <div class="card" style="margin: 0px 10px;">
                ...
                <table id="table-add-opt" class="table datatable-basic table-striped" style=" margin: 0;">
                    ...
                    <tbody>
                        ...
                        $distributors = $campaign->distributors;

                        @endphp


                        <tr>
                            <td class="text-center">{{ $distributors}}</td>
                            <td class="text-center">{{$distributors}}</td>
            ...
            <div class="card" style="margin: 0px 10px;">
                ...
                <table id="table-add-opt" class="table datatable-basic table-striped" style=" margin: 0;">
                    ...
                    <tbody>
                        ...
                        @endphp
                        <tr>
                            <td class="text-center">{{ $giftsNames}}</td>
                            <td class="text-center">{{$giftsNames}}</td>
