...
namespace App\Http\Controllers\Voyager\CampaignProducts;
    ...
    public function store(Request $request)
    {
        ...
        if(isset($input['campaign_id'])){
            ...
            if($start_date->lte($now)){
                ...
                return redirect()->back()->with([
                    'message'    => __('Campaign already has started, You cannot add product to it !!!!!'),
                    'alert-type' => 'error',
                ]);
            }
        ...
        if(isset($input['product_id'])){
            ...
            $campaignProduct = CampaignProduct::where('product_id',$input['product_id'])->where('campaign_id',$input['campaign_id'])->first();
          
            if($campaignProduct){
                
                return redirect()->back()->with([
                    'message'    => __('This product already exist in this campaign!!!!!'),
                    'alert-type' => 'error',
                ]);
            }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        foreach ($ids as $id) {
            ...
            if($start_date->lte($now)){
                ...
                return redirect()->back()->with([
                    'message'    => __('Campaign already has started, You cannot delete it !!!!!'),
                    'alert-type' => 'error',
                ]);
            }
            // Check permission
